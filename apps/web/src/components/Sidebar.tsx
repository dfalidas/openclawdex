...
function ThreadRow({
  ...
  return (
    <div
      className={`group relative flex items-center w-full ${indent ? "pl-9" : "pl-2"} pr-2 py-[7px] mb-[2px] rounded-xl text-left transition-all duration-100`}
      style={{
    ...
    >
      ...
      {!renaming && (
        <>
          ...
          <div className="absolute right-2 shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
            <button
              ref={menuBtnRef}
              onClick={(e) => {
                e.stopPropagation();
              ...
              className="p-[2px] rounded-md transition-colors"
              style={{ color: "rgba(255,255,255,0.5)" }}
            ...
            {menuOpen && menuPos && (
              <>
                ...
                <div
                  className="fixed z-50 rounded-2xl overflow-hidden p-1.5"
                  style={{
                    top: menuPos.top,
                    left: menuPos.left,
      ...
      >
        ...
        <div className="relative shrink-0">
          <button
            ...
            className="p-[3px] rounded-md opacity-0 group-hover:opacity-100 transition-opacity"
            style={{ color: "rgba(255,255,255,0.5)" }}
            onMouseEnter={(e) => (e.currentTarget.style.background = "rgba(255,255,255,0.08)")}
            onMouseLeave={(e) => (e.currentTarget.style.background = "transparent")}
          >
